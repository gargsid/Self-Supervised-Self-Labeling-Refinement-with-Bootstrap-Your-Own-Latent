...
from byol import BYOL, ProjectorHead, BYOLContrastive, BYOLSigmoid
...
model = BYOLSigmoid(theta_positive=args.theta_positive, theta_negative=args.theta_negative).to(device)
model.train()
